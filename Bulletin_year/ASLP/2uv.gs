...
t11=324+ss+1
*1975-1993year*
'define p1'ss'=ave(slp,t='t1',t=552,12)'
'define p11'ss'=ave(slp,t='t11',t=552,12)'

t2=780+ss
t22=780+ss+1
'define a1'ss'=slp(t='t2')-p1'ss''
'define a11'ss'=slp(t='t22')-p11'ss''
*2012.1*
...
*        'draw string 'pos' 'y_lon' 'xlon'E'
        if ( nx = nxlab )
          'draw string 'pos' 'y_lon-0.02' 'xlon''xaxis_unit_end''
        else
...
_nheight = '-5 -4.5 -4 -3.5 -3 -2.5 -2 -1.5 -1 -0.5 0 0.5 1 1.5 2 2.5 3 3.5 4 4.5 5' 
  endif
*
* ======================= End of this gs file ============================
return
